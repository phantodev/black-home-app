                ...
                <div className="bg-gray-100 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
                  <div className="max-w-lg mx-auto">
                    ...
                    <p className="mt-3 text-lg leading-6 text-gray-500">
                      Enrre em contato utilizando o formulário ao lado para
                      tirar dúvidas, fazer reclamação ou até mesmo fazer uma
                      encomenda de algum móvel especial. Iremos ficar felizes em
                      atender você!
                    </p>
